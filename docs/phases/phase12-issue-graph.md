...
| `phase12-005` | `console-parallel-merge-surface` | completed | parallel run、worker slot、merge preview、release batch readiness Console 展示 | `phase12-001`,`phase12-004` | `frontend_owner` | Console 可见并发执行和集成合入准备状态 |
