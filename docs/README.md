...
当前阶段：Phase 27 已完成 readiness 收口。
...
Phase 1 本地 CLI MVP、Beta 控制面能力、Phase 2 到 Phase 27 已完成主要闭环。当前验收和状态入口：

- [Phase 27 实现 Issue Graph](./phases/phase27-issue-graph.md)：Adapter Recovery Control Queue Binding 的依赖图。
- [Phase 27 实施记录](./phases/phase27-next-development-plan.md)：Phase 27 当前任务、验收标准和执行记录。
- [Phase 27 Release Readiness](./phases/phase27-release-readiness.md)：Phase 27 完成范围、门禁结论、保留边界和后续真实 adapter 入口建议。
- [Phase 26 实现 Issue Graph](./phases/phase26-issue-graph.md)：Write Adapter Failure Recovery Record 的依赖图。
- [Phase 26 实施记录](./phases/phase26-next-development-plan.md)：Phase 26 当前任务、验收标准和执行记录。
- [Phase 26 Release Readiness](./phases/phase26-release-readiness.md)：Phase 26 完成范围、门禁结论、保留边界和后续真实 adapter 入口建议。
...
- [Phase 23 实现 Issue Graph](./phases/phase23-issue-graph.md)：Write Adapter Dispatch Scaffold 的依赖图。
- [Phase 23 实施记录](./phases/phase23-next-development-plan.md)：Phase 23 当前任务、验收标准和执行记录。
- [Phase 23 Release Readiness](./phases/phase23-release-readiness.md)：Phase 23 完成范围、门禁结论、保留边界和后续真实 adapter 入口建议。
- [Phase 22 实现 Issue Graph](./phases/phase22-issue-graph.md)：受保护真实写入执行计划契约的依赖图。
- [Phase 22 实施记录](./phases/phase22-next-development-plan.md)：Phase 22 当前任务、验收标准和执行记录。
- [Phase 22 Release Readiness](./phases/phase22-release-readiness.md)：Phase 22 完成范围、门禁结论、保留边界和后续真实 adapter 入口建议。
...
- [Phase 19 Release Readiness](./phases/phase19-release-readiness.md)：Phase 19 完成范围、门禁结论、保留边界和 Phase 20 入口建议。
