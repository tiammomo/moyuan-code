...
| `phase19-005` | `console-observability-drilldown` | next | Console 展示 audit export、decision ledger、control runner 和 provider write proof | `phase19-001`,`phase19-004` | `frontend_owner` | 前端只展示事实源，不重新决策 |
