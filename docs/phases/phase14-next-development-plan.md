...
| --- | --- | --- | --- | --- | --- |
| P0 | `phase14-001` | `release-candidate-provider-publish-bridge` | planned | Candidate 接入 release provider publish | 默认 approval/preview-only 阻断，满足门禁后复用 provider adapter |
