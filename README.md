...
- Beta 已推进控制面状态 API、issue graph API、需求拆分、并发调度、review/merge decision 和 Provider Registry/runtime routing。
...
- 下一批实现重点：GitHub/Gitee provider 分支推送、PR/MR 编排、release branch pipeline、服务器资源和 DevOps 发布闭环。
