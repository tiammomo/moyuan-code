...
- 当前实现重点：Phase 20，write admission policy、provider-specific proof pack、remote execution rehearsal runner 和 control runner queue/window 已完成，下一步进入 Console proof/admission drill-down。
