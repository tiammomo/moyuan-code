...
| `phase3-004` | `runtime-log-diff-viewer` | planned | Console 展开 runtime recovery 的 stdout/stderr、diff summary、changed files 和 resume hint | `phase2-007`,`phase2-009` | `frontend_owner` | 运行失败能在 Console 看到证据链 |
