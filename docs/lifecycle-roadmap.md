...
当前已进入 Phase 17，阶段入口见 [Phase 17 实现 Issue Graph](./phases/phase17-issue-graph.md) 和 [Phase 17 实施记录](./phases/phase17-next-development-plan.md)。Phase 17 已完成 release admission policy pack、bounded rehearsal scheduler 和 risk review queue，下一步聚焦 Console policy/risk drill-down。
