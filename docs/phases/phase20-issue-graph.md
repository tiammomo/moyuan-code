...
| `phase20-002` | `provider-specific-proof-pack` | next | 为 GitHub/Gitee/SSH/cloud 维护 provider-specific proof requirements | `phase20-001` | `release_owner` + `devops_owner` | 最小权限、secret ref、evidence 和 replay guard 按 provider 可配置 |
