...
| --- | --- | --- | --- | --- | --- | --- |
| `phase18-001` | `operations-timeline` | planned | 聚合 release/deployment/admission/scheduler/risk/resource 事实为 timeline | Phase 17 readiness | `backend_owner` + `devops_owner` | 统一查询、排序、过滤、可追溯 evidence |
...
- Smoke/monitor 失败只能生成风险事实和复核入口，不能自动执行生产修复。
