...
| --- | --- | --- | --- | --- | --- |
| P0 | `phase2-001` | `skill-registry-store-api` | planned | 建立 Skill Definition、启用状态、风险和适配 role 的存储/API/CLI | 可登记、查询、禁用 skill，并被项目 workspace 持久化 |
...
## 3. 当前任务：`phase2-001 skill-registry-store-api`
