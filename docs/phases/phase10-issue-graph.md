...
| `phase10-005` | `console-route-repair-operator-surfaces` | completed | Provider route 候选矩阵、repair candidate 操作面、control loop 历史 | `phase9-004`,`phase10-001`,`phase10-002` | `frontend_owner` | Console 可查看候选、复核 repair candidate，并追踪控制循环执行历史 |
