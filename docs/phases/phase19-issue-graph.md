...
| `phase19-002` | `decision-ledger` | next | 统一记录 release admission、maintenance policy、resource readiness、verification 和 risk review decision | `phase19-001` | `release_owner` + `security_owner` | 结论结构一致，可追溯规则和来源 |
