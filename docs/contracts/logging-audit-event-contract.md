...
| DevOps 发布投产 | release_suggested、release_branch_created、release.coverage_checked、release_note.generated、deploy_started、deployment.smoke.completed、deployment.monitor.completed、deployment.rollback.suggested、rollback_started |
