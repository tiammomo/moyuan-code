...
当前已启动 Phase 17，阶段入口见 [Phase 17 实现 Issue Graph](./phases/phase17-issue-graph.md) 和 [Phase 17 实施记录](./phases/phase17-next-development-plan.md)。Phase 17 聚焦发布准入策略包、演练调度与风险修复 drill-down。
